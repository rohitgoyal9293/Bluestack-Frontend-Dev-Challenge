...
class LiveCampaignTable extends Component {
  render() {
    const { selectedTab, liveCampaignList, startDate,selectedLang } = this.props;
    return (
      <React.Fragment>
...
export default LiveCampaignTable;
